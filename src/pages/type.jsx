      ...
      <div className={`${styles.flexCenter} bg-white mb-9`}>
          <div className='w-ful h-fit grid grid-cols-1 md:grid-cols-3 justify-items-center content-center gap-6 mb-9'>
            <div className='bg-[#FF3333] flex flex-col justfify-center z-10 w-auto'>
              ...
              <button className='w-[269px] h-[68px] bg-[#FFFFFF] text-[#FF3333] font-bold text-[32px] leading-[48px] p-[10px] rounded-md mt-[35px] mb-9 lg:mt-[235px] mx-[105px] font-poppins uppercase'>Part Time</button>
            </div>
            <div className='bg-[#FFFFFF] flex flex-col justfify-center w-auto'>
              <img src={fullTime} alt="partTime" className='px-[45px] py-[25px] ' />
              <button className='w-[269px] h-[68px] bg-[#FF3333] text-[#FFFFFF] font-bold text-[32px] leading-[48px] p-[10px] rounded-md mb-9 mx-[205px] mt-[-40px] lg:mt-10 font-poppins uppercase'>Part Time</button>
            </div>
